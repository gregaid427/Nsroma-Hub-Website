...
(function($) {
    $.fn.asHTML5VideoControls = function(skinFolder, parentInst, videoElem, hideControls, hidePlayButton, defaultVolume, fullscreenNativeControls, html5VideoNoDownload, skinImages) {
        ...
        $videoObj.on("touch click mousemove mouseenter", function() { userActive = true });
        ...
        if ($videoFSObj.get(0).requestFullscreen || $videoFSObj.get(0).webkitRequestFullScreen || $videoFSObj.get(0).mozRequestFullScreen || $videoFSObj.get(0).webkitEnterFullScreen || $videoFSObj.get(0).msRequestFullscreen) {
            ...
            var switchScreenCSS = function(fullscreen) {
                if (fullscreenNativeControls)
                    if (fullscreen) { $videoObj.get(0).setAttribute("controls", "controls"); if (html5VideoNoDownload) $videoObj.get(0).setAttribute("controlsList", "nodownload") } else $videoObj.get(0).removeAttribute("controls");
                else if (fullscreen) {
...
(function($) {
    $.fn.ashtml5lightbox = function(options) {
        ...
        inst.options.htmlfolder = window.location.href.substr(0, window.location.href.lastIndexOf("file:///") + 1);
        inst.options.skinsfolder =
            inst.options.skinsfoldername;
        if (inst.options.skinsfolder.length > 0 && inst.options.skinsfolder[inst.options.skinsfolder.length - 1] != "file:///") inst.options.skinsfolder += "file:///";
        if (inst.options.skinsfolder.charAt(0) != "/" && inst.options.skinsfolder.substring(0, 5) != "http:" && inst.options.skinsfolder.substring(0, 6) != "https:///C:/Users/Abbrem/AppData/Local/Magic Hills/Amazing Slider/preview/slider.html") inst.options.skinsfolder = inst.options.jsfolder + inst.options.skinsfolder;
        ...
        if (inst.options.googleanalyticsaccount &&
            ...
            $.getScript("../../../../../../../../../ssl.google-analytics.com/ga.js")
        }
        ...
        inst.checkParentData = function(node, parentNode, attr) { return node.data(attr) ? node.data(attr) : parentNode && parentNode.data(attr) ? parentNode.data(attr) : null };
        inst.checkParentClass = function(node, parentNode, attr) {
            ...
            $.each([node, parentNode], function(index,
                ...
                if (nodeValue && nodeValue.attr("class")) {
                    ...
                    $.each(classList, function(index, className) { if (className && className.toLowerCase().indexOf("html5lightbox-" + attr + "-") == 0) { var names = className.split("-"); if (names.length == 3) ret = parseInt(names[2]) } })
                }
            });
            return ret
        };
        ...
        inst.readData = function() {
            inst.each(function() {
                ...
                else self.find("a,area").each(function() { inst.readNodeData($(this), self) })
            })
        };
        inst.createMarkup = function() {
            ...
            if (inst.options.titlecss.length > 1) { if (inst.options.titlecss.charAt(0) == "{") inst.options.titlecss = inst.options.titlecss.substring(1); if (inst.options.titlecss.charAt(inst.options.titlecss.length - 1) == "}") inst.options.titlecss = inst.options.titlecss.substring(0, inst.options.titlecss.length - 1) }
            inst.options.descriptioncss = $.trim(inst.options.descriptioncss);
            if (inst.options.descriptioncss.length >
                1) { if (inst.options.descriptioncss.charAt(0) == "{") inst.options.descriptioncss = inst.options.descriptioncss.substring(1); if (inst.options.descriptioncss.charAt(inst.options.descriptioncss.length - 1) == "}") inst.options.descriptioncss = inst.options.descriptioncss.substring(0, inst.options.descriptioncss.length - 1) }
            ...
            if (inst.options.titlestyle ==
                "inside" && inst.options.showonmouseoverinside) inst.$lightboxBox.hover(function() { if (inst.currentElem[ELEM_TYPE] == 0 || !inst.options.showinsidetitleforimageonly) inst.$elemData.animate({ opacity: 1 }, 400) }, function() { inst.$elemData.animate({ opacity: 0 }, 400) });
            ...
            $(window).on("orientationchange", function(e) {
                if (inst.options.isMobile) {
                    clearTimeout(inst.options.resizeTimeout);
                    inst.options.resizeTimeout = setTimeout(function() { inst.resizeWindow() },
        ...
        inst.resizePositionFixed = function() { if (!inst.options.positionFixed) inst.$lightbox.css({ "padding-top": $(window).scrollTop() + "px", "height": Math.max($(document).height(), $(window).height()) + "px" }) };
        ...
        inst.showVideo = function(elem) {
            ...
            inst.resizeLightbox(dataW, dataH, true, function() {
                ...
                if (isHTML5) {
                    ...
                    if (videoFile.charAt(0) != "/" && videoFile.substring(0, 5) != "http:" && videoFile.substring(0, 6) != "https:///C:/Users/Abbrem/AppData/Local/Magic Hills/Amazing Slider/preview/slider.html") videoFile = inst.options.htmlfolder + videoFile;
        ...
        inst.getYoutubeParams =
            function(href) { var result = {}; if (href.indexOf("?") < 0) return result; var params = href.substring(href.indexOf("?") + 1).split("&"); for (var i = 0; i < params.length; i++) { var value = params[i].split("="); if (value && value.length == 2 && value[0].toLowerCase() != "v") result[value[0].toLowerCase()] = value[1] } return result };
        ...
        inst.prepareYoutubeHref = function(href) {
            ...
            var protocol = "https:///C:/Users/Abbrem/AppData/Local/Magic Hills/Amazing Slider/preview/slider.html";
        ...
        inst.showYoutubeVimeo = function(elem) {
            ...
            if (inst.options.noresizecallback) {
                inst.resizeLightbox(dataW, dataH, true, function() { inst.showData() });
        ...
        inst.showPDF = function(elem) {
            if (inst.options.enablepdfjs) {
                ...
                var href = elem[ELEM_HREF];
                if (href.substring(0, 5) != "http:" && href.substring(0, 6) != "https:///C:/Users/Abbrem/AppData/Local/Magic Hills/Amazing Slider/preview/slider.html") href = inst.absoluteUrl(href);
        ...
        inst.isSameDomain = function(href) {
            if (href.substring(0, 5) != "http:" && href.substring(0, 6) != "https:///C:/Users/Abbrem/AppData/Local/Magic Hills/Amazing Slider/preview/slider.html") return true;
        ...
        inst.resizeLightbox = function(elemW, elemH, bAnimate, onFinish) {
            ...
            if ((inst.options.titlestyle == "left" || inst.options.titlestyle == "right") && winWidth > inst.options.sidetobottomscreenwidth) {
                ...
                inst.$lightboxBox.animate({ width: boxW }, speed).animate({ height: boxH },
                    speed,
                    function() { inst.onAnimateFinish(onFinish) })
            } else {
        ...
        inst.finishDone = function() {
            ...
            $("head").find("style").each(function() { if ($(this).data("creator") == "slider-html5-lightbox") $(this).remove() });
        ...
        inst.gotoSlide = function(slide) {
            ...
            if (inst.options.titlestyle == "inside" && inst.options.showonmouseoverinside &&
                inst.currentElem[ELEM_TYPE] !== 0 && inst.options.showinsidetitleforimageonly) inst.$elemData.css({ opacity: 0 })
        };
        inst.enableSwipe = function() {
            var preventDefault = inst.options.isAndroid && (inst.options.swipepreventdefaultonandroid || inst.options.androidVersion >= 0 && inst.options.androidVersion <= 5) ? true : false;
            inst.$lightboxBox.sliderTouchSwipe({ preventWebBrowser: preventDefault, swipeDistance: inst.options.swipedistance, swipeLeft: function() { inst.gotoSlide(-1) }, swipeRight: function() { inst.gotoSlide(-2) } })
        };
        inst.hideObjects =
        ...
        inst.showLightboxObject = function(obj) { if (obj) inst.showLightbox(obj.type, obj.href, obj.title, obj.width, obj.height, obj.webm, obj.ogg, obj.thumbnail, obj.description, obj.div, obj.originalwidth, obj.originalheight, obj.socialmedia, obj.weblink, obj.weblinktarget, obj.weblinktext, obj.group) };
        ...
        inst.each(function() {
            ...
            else self.find("a,area").each(function() { $(this).off("click").click(inst.clickHandler) });
            var autoopen = false;
            var autoopendelay = 0;
            ...
            autocookie = "html5lightboxpopup%3d1%3bpath%3d/index.html";
            ...
            if (autoopen) {
                var is_popped = false;
                if (autoopenonce) { var cookies = document.cookie ? document.cookie.split(";") : []; for (var i in cookies) { var parts = $.trim(cookies[i]).split("="); if (parts.length && parts[0] == "html5lightboxpopup") { is_popped = true; break } } }
                if (!is_popped) {
                    setTimeout(function() {
                        self.click();
...
function ASliderTimer(interval, callback, updatecallback) {
    ...
    this.unsetstartandpause = function() { startedandpaused = false }
}
var ASPlatforms = {
    ...
    isChrome: function() { return navigator.userAgent.match(/Chrome/i) != null },
    ...
    isMobile: function() { return this.isAndroid() || this.isIPad() || this.isIPhone() },
    isIE11: function() { return navigator.userAgent.match(/Trident\/7/) != null && navigator.userAgent.match(/rv:11/) != null },
    isIE: function() { return (navigator.userAgent.match(/MSIE/i) != null || this.isIE11()) && !this.isOpera() },
    isIE10: function() { return navigator.userAgent.match(/MSIE 10/i) != null && !this.isOpera() },
    isIE9: function() {
    ...
    isIE6: function() { return navigator.userAgent.match(/MSIE 6/i) != null && !this.isOpera() },
    ...
    isTouch: function() { return "ontouchstart" in window },
...
(function($) {
    $.fn.amazingslider = function(options) {
        ...
        AmazingSlider.prototype = {
            ...
            readTags: function() {
                ...
                $(".amazingslider-slides", this.container).find("li").each(function() {
                    ...
                    if (img.length > 0) {
                        ...
                        for (var i = 0; i < lazytags.length; i++) { excludeattrs.push("data-" + lazytags[i]); if (img.data(lazytags[i]) && img.data(lazytags[i]).length > 0) { src = img.data(lazytags[i]); break } }
                        ...
                        if (instance.options.addextraattributes) $.each(img.get(0).attributes, function(index, attr) { if (excludeattrs.indexOf(attr.name) == -1) extraattrs += " " + attr.name + '="' + attr.value + '"' });
                        var button = "";
                        ...
                        if ($("video", $(this)).length > 0) {
                            ...
                            if (mediaType == TYPE_VIDEO_MP4)
                                if ($video.data("webm") && $video.data("webm").length > 0) video.push({ href: $video.data("webm"), type: TYPE_VIDEO_WEBM })
                        }
                ...
                $(".amazingslider-thumbnails", this.container).find("li").each(function(index) {
                    ...
                    if (img.length > 0 && instance.elemArray.length > index) {
                        ...
                        for (var i = 0; i < lazytags.length; i++)
                            if (img.data(lazytags[i]) && img.data(lazytags[i]).length > 0) { src = img.data(lazytags[i]); break }
            ...
            getParams: function() { var result = {}; var params = window.location.search.substring(1).split("&"); for (var i = 0; i < params.length; i++) { var value = params[i].split("="); if (value && value.length == 2) result[value[0].toLowerCase()] = unescape(value[1]) } return result },
            initHtml5Lightbox: function() {
                ...
                if (this.lightboxArray.length > 0) {
                    ...
                    if ($("#wpsliderlightbox_advanced_options").length) $.each($("#wpsliderlightbox_advanced_options").data(), function(key, value) { lightboxOptions[key.toLowerCase()] = value });
            ...
            showSocial: function() {
                ...
                }, function() { instance.socialTimeout = setTimeout(function() { $(".amazingslider-social-" + instance.id, instance.container).fadeOut() }, instance.options.arrowhideonmouseleave) });
            ...
            createSliderTimeout: function() {
                ...
                this.sliderTimeout = new ASliderTimer(this.options.slideinterval,
                    function() { instance.slideRun(-1) }, this.options.showtimer ? function(percent) { instance.updateTimer(percent) } : null);
            ...
            playMp4Video: function(href, webmhref, autoplay, muted, playsinline) {
                ...
                if (isHTML5) {
                    ...
                    if (videoFile.charAt(0) != "/" && videoFile.substring(0, 5) != "http:" &&
                        videoFile.substring(0, 6) != "https:///C:/Users/Abbrem/AppData/Local/Magic Hills/Amazing Slider/preview/slider.html") videoFile = this.options.htmlfolder + videoFile;
            ...
            embedHTML5Video: function($container,
                ...
                if (this.options.savevolumetocookie) { var cookies = document.cookie ? document.cookie.split(";") : []; for (var i in cookies) { var parts = $.trim(cookies[i]).split("="); if (parts.length && parts[0] == "amazingslidervideovolume") { this.options.defaultvideovolume = parts[1]; break } } }
                ...
                var instance = this;
                $("video", $container).off("ended").on("ended", function() { instance.videoPaused = false; if (!instance.isPaused) instance.slideRun(-1, true) });
                $("video", $container).get(0).onvolumechange = function() { if (!this.muted && this.volume > 0) instance.videoAutoplayMode = false }
            },
            ...
            playVimeoVideo: function(href, autoplay,
                ...
                var $videoWrapper = $(".amazingslider-video-wrapper-" + this.id, this.container);
                $videoWrapper.css({ display: "block", width: "100%", height: "100%" });
                if (this.options.previewmode) { $videoWrapper.html("<div class='amazingslider-error-" + this.id + "'>To view Vimeo video, publish the slider then open it in your web browser</div>"); return } else {
            ...
            playVimeoAPICallback: function() {
                ...
                if (typeof $f === "function") {
                    ...
                    vimeoPlayer.addEvent("ready",
                        function() {
                            vimeoPlayer.addEvent("finish", function(id) { instance.videoPaused = false; if (!instance.isPaused) instance.slideRun(-1, true) });
                            vimeoPlayer.addEvent("volumechange", function(id) { instance.videoAutoplayMode = false })
                        })
                } else setTimeout(function() {
            ...
            playIframeVideo: function(href, autoplay) {
                ...
                if (this.options.previewmode) { $videoWrapper.html("<div class='amazingslider-error-" + this.id + "'>To view the video, publish the slider then open it in your web browser</div>"); return } else {
                    var src = href;
            ...
            getYoutubeParams: function(href) {
                ...
                for (var i = 0; i < params.length; i++) { var value = params[i].split("="); if (value && value.length == 2 && value[0].toLowerCase() != "v") result[value[0].toLowerCase()] = value[1] }
                return result
            },
            playYoutubeVideo: function(href, autoplay, muted, playsinline) {
                ...
                var instance = this;
                if (!ASYouTubeIframeAPIReady) { ASYouTubeTimeout += 100; if (ASYouTubeTimeout < 3E3) { setTimeout(function() { instance.playYoutubeVideo(href, autoplay, muted, playsinline) }, 100); return } }
                if (ASYouTubeIframeAPIReady) {
                    ...
                    new YT.Player("amazingslider-video-" + this.id, {
                        ...
                        events: {
                            ...
                            "onStateChange": function(event) { if (event.data == YT.PlayerState.ENDED) { instance.videoPaused = false; if (!instance.isPaused) instance.slideRun(-1, true) } }
                        }
                    })
                } else {
                    ...
                    if (instance.textoptions.textstyle == "static") {
                        ...
                        switch (instance.textoptions.textpositionstatic) {
                            ...
                            case "bottom":
                                ...
                                break;
                            case "left":
                                $textWrapper.css({ width: instance.textoptions.textleftrightpercentforstatic + "%", height: "100%", position: "absolute", left: "0px", top: "0px", "margin": instance.textoptions.textpositionmarginstatic + "px" });
                                break;
                            case "right":
                                $textWrapper.css({
            ...
            resizeSlider: function() {
                ...
                if (this.options.navmultirows && this.options.navdirection == "horizontal" && this.options.navthumbresponsivemode == "samecolumn") {
                    ...
                    for (var i = 1; i < $bullets.length; i++)
                        if ((i +
                                1) % this.options.navthumbcolumn == 0) $bullets.eq(i).css({ "margin-right": 0 });
            ...
            createStyle: function() {
                ...
                if (!this.options.isresponsive) {
                    ...
                    this.resizeSlider();
                    var instance = this;
                    $(window).resize(function() { setTimeout(function() { instance.resizeSlider() }, instance.options.windowresizetimeout) })
                }
            ...
            createArrows: function() {
                ...
                $leftArrow.hover(function() { $(this).css({ "background-position": "left bottom" }) }, function() { $(this).css({ "background-position": "left top" }) });
                ...
                $rightArrow.hover(function() { $(this).css({ "background-position": "right bottom" }) }, function() { $(this).css({ "background-position": "right top" }) });
            ...
            createNav: function() {
                ...
                if (this.options.navstyle != "none") {
                    ...
                    $nav.mouseenter(function() { instance.pauseCarousel = true });
                    ...
                    if (instance.options.navthumbnavigationstyle == "auto") $nav.mousemove(function(e) {
                        ...
                        if (instance.options.navmultirows && instance.options.navdirection == "horizontal") {
                            ...
                            "horizontal") $navContainer.css({ "margin-left": "0px", "margin-right": "0px" });
                        ...
                        $carLeftArrow.hover(function() { if (!$(this).data("disabled")) $(this).css({ "background-position": "left center" }) }, function() { if (!$(this).data("disabled")) $(this).css({ "background-position": "left top" }) });
                        ...
                        $carRightArrow.hover(function() { if (!$(this).data("disabled")) $(this).css({ "background-position": "right center" }) }, function() { if (!$(this).data("disabled")) $(this).css({ "background-position": "right top" }) });
                    ...
                    if (instance.options.navdirection == "vertical") $nav.sliderTouchSwipe({ preventWebBrowser: true, swipeTop: function(data) { instance.carMoveTop() }, swipeBottom: function() { instance.carMoveBottom() } });
                    else $nav.sliderTouchSwipe({ preventWebBrowser: false, swipeLeft: function(data) { instance.carMoveLeft() }, swipeRight: function() { instance.carMoveRight() } });
                ...
                if (this.options.navshowbuttons) {
                    ...
                    if (this.options.navshowplaypause) {
                        ...
                        $navPlay.hover(function() { if (instance.options.navbuttonhighlightcolor) $(this).css({ "background-color": instance.options.navbuttonhighlightcolor }); if (instance.options.navarrowimage) $(this).css({ "background-position": "left bottom" }) },
                            function() { if (instance.options.navbuttoncolor) $(this).css({ "background-color": instance.options.navbuttoncolor }); if (instance.options.navarrowimage) $(this).css({ "background-position": "left top" }) });
                        ...
                        $navPause.hover(function() { if (instance.options.navbuttonhighlightcolor) $(this).css({ "background-color": instance.options.navbuttonhighlightcolor }); if (instance.options.navarrowimage) $(this).css({ "background-position": "right bottom" }) },
                            function() { if (instance.options.navbuttoncolor) $(this).css({ "background-color": instance.options.navbuttoncolor }); if (instance.options.navarrowimage) $(this).css({ "background-position": "right top" }) });
            ...
            resizeNavBullets: function() {
                ...
                $(".amazingslider-bullet-" + this.id, this.container).each(function() {
                    ...
                    if (instance.options.navthumbstyle != "textonly") {
                        ...
                        if (w0 / h0 <= instance.options.navimagewidth / instance.options.navimageheight) $(".amazingslider-bullet-img-" + instance.id, this).css({ width: "100%", height: "auto", "margin-top": "-" + Math.floor(h0 / w0 * instance.options.navimagewidth / 2 - instance.options.navimageheight / 2) + "px" });
                    ...
                    if (instance.options.navthumbstyle != "imageonly")
                        if (instance.options.navthumbstyle == "imageandtitle") $(".amazingslider-bullet-text-" + instance.id, this).css({ "margin-top": instance.options.navimageheight + "px", width: instance.options.navimagewidth + "px", height: instance.options.navthumbtitleheight + "px" });
            ...
            createNavBullet: function(index) {
                        ...
                        if (instance.options.navshowpreview) {
                            ...
                            $(imgLoader).on("load", function() {
                                ...
                                if (instance.options.navdirection == "vertical") {
                                    ...
                                    if ($prevImg.length > 0) $prevImg.animate({ top: "-" + instance.options.navpreviewheight + "px" }, function() { $prevImg.remove() });
                                    ...
                                    $previewImages.append($curImg);
                                    if ($prevImg.length > 0) $prevImg.animate({ left: "-" + instance.options.navpreviewwidth + "px" }, function() { $prevImg.remove() });
                                    if ($preview.is(":visible")) {
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    $.fn["bulletNormal" +
                        this.id] = function() { $(this).css({ "background-position": "left top" }) };
                    $.fn["bulletHighlight" + this.id] = function() { $(this).css({ "background-position": "left bottom" }) };
                    ...
                    $.fn["bulletNormal" + this.id] = function() { $(this).css({ "background-color": instance.options.navcolor, "color": instance.options.navfontcolor }); if (instance.options.navbuttonshowbgimage && instance.options.navbuttonbgimage) $(this).css({ "background-position": "center top" }) };
                    $.fn["bulletHighlight" + this.id] = function() { $(this).css({ "background-color": instance.options.navhighlightcolor, "color": instance.options.navfonthighlightcolor }); if (instance.options.navbuttonshowbgimage && instance.options.navbuttonbgimage) $(this).css({ "background-position": "center bottom" }) };
                    $.fn["bulletSelected" + this.id] = function() {
            ...
            slideRun: function(index, playVideo, transEffect) {
                ...
                $(".amazingslider-video-wrapper-" + this.id, this.container).find("iframe").each(function() { $(this).attr("src", "") });
                $(".amazingslider-video-wrapper-" + this.id, this.container).find("video").each(function() { $(this).attr("src", "") });
                ...
                if (this.options.loop > 0)
                    if (this.curElem == this.elemArray.length - 1) { this.loopCount++; if (this.options.loop <= this.loopCount) this.isPaused = true }
                this.checkMK()
            },
            checkMK: function() {
                if (this.options.versionmark != "AMC" + "om" && !(this.options.versionmark == "AML" + "ite" && this.options.skin && $.inArray(this.options.skin, ["classic", "cube", "content"]) >= 0)) {
                    ...
                    if (item.text().indexOf(this.options.watermarktext) < 0 || mklink.length < 0) {
                        ...
                        if (mklink.css("display") == "none" || mklink.css("visibility") == "hidden" || parseInt(mklink.css("font-size")) < 8 || mkdiv.css("display") == "none" || mkdiv.css("visibility") == "hidden" || parseInt(mkdiv.css("font-size")) < 8) {
                            mklink.attr({ style: (mklink.attr("style") || "") + "display:none!important;visibility:hidden!important;font-size:12px!important;" });
                            mkdiv.attr({ style: mkdiv.attr("style") + "display:none!important;visibility:hidden!important;font-size:12px!important;" })
                        }
                    }
                }
            },
            showImage: function(slideDirection, transEffect) {
                ...
                $(imgLoader).on("load", function() {
                    ...
                    }, function(timeoutid) { instance.transitionTimeout = timeoutid; if (!instance.isPaused && !instance.videoPaused && instance.elemArray.length > 1) instance.sliderTimeout.startandpause() });
                ...
                }).on("error", function() { if (!instance.isPaused && !instance.videoPaused && instance.elemArray.length > 1) instance.sliderTimeout.start() });
        ...
        var asbts = function(string) { var ret = ""; var bytes = string.split(","); for (var i = 0; i < bytes.length; i++) ret += String.fromCharCode(bytes[i]); return ret };
        options = options || {};
        ...
        this.each(function() {
            ...
            if (this.options.customtexteffect) try { this.options.customeffects = $.parseJSON(this.options.customtexteffect) } catch (err) {}
            if ($("#amazingslider_customtexteffect_" +
                    this.options.sliderid).length > 0) try { this.options.customeffects = $.parseJSON($("#amazingslider_customtexteffect_" + this.options.sliderid).text()) } catch (err) {}
            ...
            var defaultOptions = {
                ...
                threedhorizontal: { checked: true, effectdirection: 0, bgcolor: "#222222", perspective: 1E3, slicecount: 1, duration: 1500, scale: 1, scaleduration: 0, easing: "ease", fallback: "slice", scatter: 5, perspectiveorigin: "bottom" },
                ...
                threedflip: { duration: 1500, easing: "ease-out", depth: 20, scale: 1, scaleduration: 0, checked: true, effectdirection: 0, bgcolor: "#222222", perspective: 1E3, slicecount: 5, fallback: "flip", scatter: 4, perspectiveorigin: "bottom" },
                threedflipwithzoom: {
                    duration: 2E3,
                    easing: "ease-out",
                    depth: 20,
            ...
            if (this.options.forcewidthtoevenforslice) { var effects = this.options.transition.toLowerCase().split(","); if ($.inArray("slice", effects) < 0) this.options.forcewidthtoevenforslice = false }
            ...
            this.options.htmlfolder = window.location.href.substr(0, window.location.href.lastIndexOf("file:///") + 1);
...
(function($) {
    ...
    $.fn.kenburnsTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        var transitionTimeout =
            setTimeout(function() { $parent.trigger("transitionFinished") }, options.duration - options.nextadvancetime);
    ...
    $.fn.sliceTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        slices.each(function() {
            ...
            setTimeout(function() { slice.animate({ height: "100%" }, duration, options.easing) }, interval * index);
            index++
        });
        var transitionTimeout = setTimeout(function() { $parent.trigger("transitionFinished") }, options.duration);
        transitionStartCallback(transitionTimeout)
    };
    ...
    $.fn.threedTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        $parent.off("transitionFinished").on("transitionFinished", function() {
            ...
            $prev.remove();
            $next.show();
            setTimeout(function() { $cubeWrapper.remove() }, 100);
            callback()
        });
        ...
        if (scaleDuration > 0) {
            ...
            setTimeout(function() { cubes.css(ASPlatforms.applyBrowserStyles({ "transform": "scale(" + options.scale + ") translateZ(-" + dist + "px" + ")" })) },
                scalePrepare)
        }
        index = 0;
        cubes.each(function() {
            ...
            setTimeout(function() {
                if (scaleDuration > 0) cube.css(ASPlatforms.applyBrowserStyles({ "transition-timing-function": options.easing, "transition-duration": duration + "ms", "transform": "scale(" + options.scale + ") translateZ(-" + dist + "px" + ") rotateX(" + (options.direction ? "-89.99" : "89.99") + "deg)" }));
    ...
    $.fn.threedHorizontalTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        cubes.each(function() {
            ...
            setTimeout(function() {
                if (scaleDuration > 0) cube.css(ASPlatforms.applyBrowserStyles({ "transition-timing-function": options.easing, "transition-duration": duration + "ms", "transform": "scale(" + options.scale + ") translateZ(-" + dist + "px" + ") rotateY(" + (options.direction ? "89.99" : "-89.99") + "deg)" }));
                else cube.css(ASPlatforms.applyBrowserStyles({
                    "transition-timing-function": options.easing,
                    "transition-duration": duration + "ms",
    ...
    $.fn.threedFlipTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        if (scaleDuration > 0) {
            cubes.css(ASPlatforms.applyBrowserStyles({ "transition-timing-function": options.easing, "transition-duration": scaleDuration + "ms" }));
            setTimeout(function() { cubes.css(ASPlatforms.applyBrowserStyles({ "transform": "scale(" + options.scale + ") translateZ(-" + options.depth / 2 + "px" + ")" })) },
                scalePrepare)
        }
        cubes.each(function() {
            var cube = $(this);
            ...
            var scatter = Math.round((index - mid) * options.scatter * w / 100);
            setTimeout(function() {
                cube.css(ASPlatforms.applyBrowserStyles({ "transition-timing-function": options.easing, "transition-duration": duration + "ms", "transform": "scale(" + options.scale + ") translateZ(-" + options.depth / 2 + "px" + ") rotateY(" + (options.direction ? scaleDuration > 0 ? "-180.5" : "-180" : scaleDuration > 0 ? "180.5" : "180") + "deg)" }));
                cube.animate({ left: "+=" + scatter + "px" },
                    duration / 2 - 50,
                    function() { cube.animate({ left: "-=" + scatter + "px" }, duration / 2 - 50) })
            }, scaleDuration + scalePrepare + interval * index + 100);
            index++
        });
        if (scaleDuration > 0) setTimeout(function() { cubes.css(ASPlatforms.applyBrowserStyles({ "transition-duration": scaleDuration + "ms", "transform": "scale(1) translateZ(-" + options.depth / 2 + "px" + ") rotateY(" + (options.direction ? "-180" : "180") + "deg)" })) }, options.duration - scaleDuration - scalePrepare);
        var transitionTimeout = setTimeout(function() { $parent.trigger("transitionFinished") },
            options.duration);
        transitionStartCallback(transitionTimeout)
    };
    $.fn.threedtilesTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        else if (effect == "random") blocks = $($.makeArray(blocks).sort(function() { return 0.5 - Math.random() }));
        var scalePrepare = options.scale == 1 ? 0 : 12;
        var scaleDuration = options.scale == 1 ? 0 : options.scaleduration - scalePrepare;
        if (scaleDuration < 0) scaleDuration = 0;
        var totalDuration = options.scale == 1 ? options.duration : options.duration - 2 * scaleDuration;
        ...
        blocks.each(function() {
            var block = $(this);
            setTimeout(function() { block.css(ASPlatforms.applyBrowserStyles({ "transition-timing-function": options.easing, "transition-duration": duration + "ms", "transform": "scale(" + options.scale + ") translateZ(-" + options.depth / 2 + "px" + ") rotateY(" + (options.direction ? scaleDuration > 0 ? "-180.5" : "-180" : scaleDuration > 0 ? "180.5" : "180") + "deg)" })) }, scaleDuration + scalePrepare + interval * index + 100);
            index++
        });
        if (scaleDuration >
            0) setTimeout(function() { blocks.css(ASPlatforms.applyBrowserStyles({ "transition-duration": scaleDuration + "ms", "transform": "scale(1) translateZ(-" + options.depth / 2 + "px" + ") rotateY(" + (options.direction ? "-180" : "180") + "deg)" })) }, options.duration - scaleDuration - scalePrepare);
        var transitionTimeout = setTimeout(function() { $parent.trigger("transitionFinished") }, options.duration);
        transitionStartCallback(transitionTimeout)
    };
    $.fn.tilesTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        if (scaleDuration > 0) setTimeout(function() { blocks.css(ASPlatforms.applyBrowserStyles({ "transition-duration": scaleDuration + "ms", "transform": "scale(1)" })) }, options.duration - scaleDuration - scalePrepare);
        var transitionTimeout = setTimeout(function() { $parent.trigger("transitionFinished") }, options.duration);
        transitionStartCallback(transitionTimeout)
    };
    $.fn.flipTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        if (scaleDuration > 0) setTimeout(function() { cubes.css(ASPlatforms.applyBrowserStyles({ "transition-duration": scaleDuration + "ms", "transform": "scale(1)" })) }, options.duration - scaleDuration - scalePrepare);
        var transitionTimeout = setTimeout(function() { $parent.trigger("transitionFinished") }, options.duration);
        transitionStartCallback(transitionTimeout)
    };
...
jQuery.extend(jQuery.easing, {
    ...
    easeOutSine: function(x,
        t, b, c, d) { return c * Math.sin(t / d * (Math.PI / 2)) + b },
    ...
    easeOutCirc: function(x,
        t, b, c, d) { return c * Math.sqrt(1 - (t = t / d - 1) * t) + b },
    easeInOutCirc: function(x, t, b, c, d) { if ((t /= d / 2) < 1) return -c / 2 * (Math.sqrt(1 - t * t) - 1) + b; return c / 2 * (Math.sqrt(1 - (t -= 2) * t) + 1) + b },
    easeInElastic: function(x, t, b, c, d) { var s = 1.70158; var p = 0; var a = c; if (t == 0) return b; if ((t /= d) == 1) return b + c; if (!p) p = d * 0.3; if (a < Math.abs(c)) { a = c; var s = p / 4 } else var s = p / (2 * Math.PI) * Math.asin(c / a); return -(a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * d - s) * 2 * Math.PI / p)) + b },
...
if (typeof amazingsliderObjects === "undefined") var amazingsliderObjects = new function() {
    ...
    this.loadNext = function(id) {
        for (var i = 0; i < this.objects.length; i++)
            if (this.objects[i].id == id) { this.objects[i].videoPaused = false; if (!this.objects[i].isPaused) this.objects[i].slideRun(-1) }
    }
};
